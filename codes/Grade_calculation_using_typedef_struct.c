...
// We have called the function by value. That's why the value of local variable has changed inside function. But outside the function,
//the value of global variable has remained same. That's why, the grades are not being showed up.
